...
public class UpdateStateAsyncTask extends AsyncTask<Void, Void, Integer> {

        private final static Integer RESULT_OK = 1;
        private final static Integer RESULT_FAILURE = 0;

        private WeakReference<UpdateStateService> mUpdateStateService;
        private JobParameters mJob;

        public UpdateStateAsyncTask(WeakReference<UpdateStateService> updateStateService, JobParameters job) {
        ...
        protected void onPostExecute(Integer resultCode) {
            mUpdateStateService.get().jobFinished(mJob, false);
        }
